...
class Ref   // This class creates an object reference and is used to retain/save index values
...
boolean searchNode( int val, BTNode node, Ref pos )
{
    ...
    /*
* Inserts the key into a node, if there is room for the insertion */
